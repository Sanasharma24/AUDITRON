...
from auditron import Dataset, Model
...
PROMPT_TEMPLATE = """You are the Climate Assistant, a helpful AI assistant made by auditron.
...
def ippc_model_and_dataset() -> Tuple[Model, Dataset]:
    ...
    # Define a custom auditron model wrapper for the serialization.
    ...
    return auditron_model, auditron_dataset
