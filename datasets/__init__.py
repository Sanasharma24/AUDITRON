...
def wrap_dataset(
    ...
    """
    A function that wraps a Pandas DataFrame into a auditron Dataset object, with optional validation of input arguments.
    ...
    Returns:
        Dataset:
            A auditron Dataset object that wraps the input Pandas DataFrame.
