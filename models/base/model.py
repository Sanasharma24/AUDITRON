...
from auditron.client.dtos import ModelMetaInfo
from auditron.core.errors import auditronInstallationError

from ...core.core import ModelMeta, ModelType, SupportedModelTypes
from ...core.validation import configured_validate_arguments
from ...datasets.base import Dataset
from ...exceptions.auditron_exception import python_env_exception_helper
...
META_FILENAME = "auditron-model-meta.yaml"
...
class BaseModel(ABC):
    ...
    def predict(self, dataset: Dataset, *_args, **_kwargs) -> ModelPredictionResults:
        """Generates predictions for the input auditron dataset.
    ...
    def __str__(self) -> str:
        ...
        return super().__str__()  # default to `<auditron.models.base.Model object at ...>`
    ...
    def _get_available_tools(self, dataset: Dataset, scan_report: ScanReport) -> dict:
        ...
        ----------
        dataset : Dataset
            auditron Dataset to be analysed by Tools.
        scan_report : ScanReport
            auditron Scan Report to be analysed by Tools.
        ...
        try:
            ...
            raise auditronInstallationError(flavor="talk") from err
    ...
    def talk(self, question: str, dataset: Dataset, scan_report: ScanReport = None, context: str = ""):
        ...
        """
        try:
            from ...llm.client.copilot import auditronCopilotClient, ToolChatMessage
