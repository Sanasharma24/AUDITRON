...
from auditron.core.core import ModelMeta, ModelType, SupportedModelTypes
from auditron.core.validation import configured_validate_arguments, validate_is_pandasdataframe
from auditron.datasets.base import Dataset
from auditron.models.base import BaseModel, WrapperModel
...
def validate_model_loading_and_saving(model: BaseModel):
    ...
    try:
        with tempfile.TemporaryDirectory(prefix="auditron-model-") as f:
            model.save(f)

            with open(f + "/auditron-model-meta.yaml", encoding="utf-8") as yaml_f:
