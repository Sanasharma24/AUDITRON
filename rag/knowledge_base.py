...
logger = logging.getLogger("auditron.rag")
...
class KnowledgeBase:
    ...
    embedding_model: BaseEmbedding, optional
        The auditron embedding model to use for the knowledge base. By default we use auditron default model which is OpenAI "text-embedding-3-small".
